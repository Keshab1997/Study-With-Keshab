...
- "calculation" for step-by-step calculations (like handwritten notes)

IMPORTANT NOTES:
- Field name must be "sections" not "content"
- Use ONLY English digits (0-9), NO Bengali digits (০-৯)
- For calculations, use newline (\n) to show steps vertically
...
{"type": "calculation", "content": "(45)²\n= 1625\n+  40\n------\n= 2025"}
```

### গুরুত্বপূর্ণ নোট:
- JSON এ field name **"sections"** হতে হবে, "content" নয়
- Class Number field **"classNumber"** হতে হবে, "classNum" নয়
- সব সংখ্যা **English digits** (0-9) হতে হবে
- Calculation type খাতার মতো নিচে নিচে দেখায়
